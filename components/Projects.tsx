...
function Projects({ }: Props) {
    ...
    return (
        ...
        >
            ...
            <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-madatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#61DAFB]/80'>
