  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        className="rounded-full border border-gray-500 object-cover h-12 w-12 md:w-16 md:h-16 xl:w-20 xl:h-20 filter group-hover:grayscale grayscale-0 transition duration-300 ease-in-out"
      />
